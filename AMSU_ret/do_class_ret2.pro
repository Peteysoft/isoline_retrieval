...
for i=0L, ndays-1 do begin
  ...
  for j=0L, na-1 do begin
    ...
    resultfile=basepath+"data/cret/"+string(days[i].year, days[i].month, days[i].day, $
    ...
    ;stop
    command="../src/retrieve_isoline2 "+level3_afile+" "+level3_bfile+" "+resultfile
    print, command
