...
confile="ecmwf"+dates+'_cld'+slev_string+'s'+vmrt_string+"SQ0.00z.ret.b.con"
...
device, /portrait, xsize=6.5, ysize=5.5, /inches
device, /Helvetica

plot, path_cons, conint, xtitle="confidence", $
	  	ytitle="tolerance", yrange=[0, 1], $
		title="Tolerance interval vs. confidence rating", charsize=1.5, $
		thick=1.5
...
save, path_cons, conint, filename="confunc.idlsav"
